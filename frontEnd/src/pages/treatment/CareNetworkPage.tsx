...
const PROVIDERS = [
  { icon: 'local_hospital', name: 'Gleneagles Hospital', specialty: 'Orthopaedic & Trauma Surgery', url: 'https://gleneagles.com.my/medical-specialties/orthopaedic-trauma-surgery', category: 'Surgery' as ProviderCategory, coords: [3.1601, 101.7408] as [number, number] },
  { icon: 'precision_manufacturing', name: 'KPJ Healthcare', specialty: 'Knee Osteoarthritis Replacement Package', url: 'https://kpjhealth.com.my/orthopaedic-care', category: 'Surgery' as ProviderCategory, coords: [3.1345, 101.6267] as [number, number] },
  { icon: 'clinical_notes', name: 'Pantai Hospital KL', specialty: 'Knee Osteoarthritis Screening Package', url: 'https://www.pantai.com.my/kuala-lumpur/packages-promotions/knee-osteoarthritis-screening-package', category: 'Screening' as ProviderCategory, coords: [3.1197, 101.6669] as [number, number] },
  ...
  { icon: 'physical_therapy', name: 'Rootheal Group', specialty: 'Specialized Osteoarthritis Treatment', url: 'https://roothealgroup.com/osteoarthritis-treatment/', category: 'Physiotherapy' as ProviderCategory, coords: [3.0903, 101.7247] as [number, number] },
  { icon: 'search_insights', name: 'Sunway Medical Centre', specialty: 'Orthopaedic Specialist Directory', url: 'https://www.sunwaymedical.com/en/conditions-and-treatments/knee-osteoarthritis', category: 'Surgery' as ProviderCategory, coords: [3.0673, 101.6092] as [number, number] },
  { icon: 'physical_therapy', name: 'YourPhysio Cheras', specialty: 'Targeted Physiotherapy & Rehabilitation', url: 'https://yourphysio.my/', category: 'Physiotherapy' as ProviderCategory, coords: [3.0983, 101.7371] as [number, number] },
];
                ...
                {filteredProviders.map((provider, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`bg-[#13141A]/50 backdrop-blur-md rounded-2xl border p-6 flex flex-col justify-between transition-all duration-300 select-none text-left relative group overflow-hidden ${isAIRecommended
