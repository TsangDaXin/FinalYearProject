...
export function PaperDesignBackground({
  ...
  const config = useMemo(() => {
    ...
    if (isDark) {
      return {
        back: "#00000000",
        front: mix("#453027", "#FF6D29", t * 0.35), // Dark Brown to Vibrant Orange
        bg: "#161316", // Almost Black background
        speed: 0.28 + t * 0.35,
        px: Math.round(2 + t * 2), // 2..4
        scale: 1.05 + t * 0.15,
        glow: "radial-gradient(60% 40% at 50% 40%, rgba(255,109,41,0.15), transparent 70%)",
      }
    } else {
      return {
        back: "#00000000",
