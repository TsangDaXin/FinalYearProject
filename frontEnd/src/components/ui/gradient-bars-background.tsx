...
export const GradientBars: React.FC<GradientBarsProps> = ({
  numBars = 15,
  gradientFrom = 'rgb(255, 109, 41)', // Default to theme orange
...
export default function Component({
  numBars = 7,
  gradientFrom = 'rgb(255, 109, 41)', // Match theme orange
  gradientTo = 'transparent',
  animationDuration = 2,
  backgroundColor = 'transparent', // Make default transparent to blend with parent section
  children,
  className = '',
  id
}: ComponentProps) {
  return (
    ...
    >
      <GradientBars
        ...
        className="opacity-80" // Increased opacity to make bars more vibrant
      />
...
export { Component as GradientBarsBackground };
